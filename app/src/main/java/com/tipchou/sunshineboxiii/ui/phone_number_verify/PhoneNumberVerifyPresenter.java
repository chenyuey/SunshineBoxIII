...
import com.tipchou.sunshineboxiii.support.ActivityCollectorUtils;
    ...
    private CountDownTimer timer = new CountDownTimer(60000, 1000) {
        ...
        public void onFinish() {
            if (view != null) {
                ...
                view.setResendButtonText(Objects.requireNonNull(App.Companion.getMAppContext()).getString(R.string.phone_number_verify_act_string4));
